...
By now the code can perform live sniffing for TCP packets and export the basic analysis in a CSV format file.
Next I'm going to develop a TLS handshake analysis and the JA3/JA4 fingerprinting.
